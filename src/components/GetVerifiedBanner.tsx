        ...
        <div className="min-w-0 flex-1">
          ...
          >
            ...
            <input
              ...
              className="w-full sm:flex-1 bg-background border border-violet-500/20 rounded-lg px-3 py-2 text-sm text-textMain placeholder:text-textMuted focus:outline-none focus:ring-2 focus:ring-brand/70"
            />
