                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="text-[10px] uppercase font-bold text-indigo-400 tracking-wider mt-1">
                          {pitch.channel}
                        </div>
                      </div>
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 shrink-0 rounded-lg border border-slate-700 bg-slate-800/40 px-2.5 py-1.5 text-[11px] font-semibold text-slate-300 hover:border-indigo-500/40 hover:text-white transition-colors"
                      >
                        {copiedIndex === index ? (
                          <>
            ...
            {!loading && !result && !error && (
              <div className="flex flex-col items-center justify-center text-center min-h-[360px] px-4">
                <div className="w-14 h-14 rounded-2xl bg-indigo-600/15 border border-indigo-500/25 flex items-center justify-center mb-4">
                  <Megaphone className="w-7 h-7 text-indigo-400" aria-hidden />
                </div>
