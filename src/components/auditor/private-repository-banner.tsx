...
export default function PrivateRepositoryBanner({
  ...
  if (variant === "public") {
    return (
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed text-yellow-50/90">
          {message}
        </p>
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-brand text-white shadow-sm px-4 py-3 text-sm font-bold tracking-tight transition-colors duration-200 hover:bg-brandHover cursor-pointer sm:flex-1"
          >
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-sm leading-relaxed text-yellow-50/90">{message}</p>
