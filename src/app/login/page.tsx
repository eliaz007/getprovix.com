...
const AUTH_PRIMARY_BUTTON_CLASS =
  "inline-flex w-full items-center justify-center rounded-md bg-[#F4F4F6] text-[#0B0B0D] shadow-sm px-4 py-2.5 text-sm font-medium transition-colors hover:bg-brandHover disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer";
