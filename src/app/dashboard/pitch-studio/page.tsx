          ...
          <div className="lg:col-span-6 card-edge bg-panel rounded-2xl border border-border p-7 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#070709] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-zinc-100 placeholder:text-zinc-600 placeholder:text-textMuted resize-none focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand/20 leading-relaxed"
              />
            </div>
