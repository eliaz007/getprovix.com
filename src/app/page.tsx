    ...
    <AmbientLighting>
      ...
      <main className="mx-auto flex max-w-6xl flex-col px-6 pb-20 pt-16 sm:pt-24">
        <div className="relative">
          <div
            aria-hidden
            className="pointer-events-none absolute top-1/4 left-1/2 -z-10 h-[380px] w-[650px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-b from-violet-600/18 via-indigo-500/10 to-transparent blur-[140px]"
          />
          <section className="hero-fade-in relative mx-auto max-w-4xl text-center">
            <p className="mb-5 inline-flex rounded-full border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 font-mono text-[11px] font-medium uppercase tracking-widest text-cyan-400 backdrop-blur-md">
